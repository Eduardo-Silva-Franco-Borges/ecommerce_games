...
describe('fluxoVenda',()=>{
    ...
    it('fluxoVenda',()=>{
        ...
        cy.wait(1500);
        cy.get('#valorEscolhidoPrestacao').type('150');
        cy.wait(1500);
        ...
        cy.wait(1500);
        cy.get('#qtdParaTrocaProduto').type('1');
        ...
        cy.get(':nth-child(16) > tbody > :nth-child(2) > :nth-child(1) > input').click();
        cy.wait(1500);
        cy.get('#valorEscolhidoPrestacao').type('190');
        cy.wait(1500);
        cy.get('#quantidadePrestacao').select('3');
        cy.wait(1500);
        cy.get('.col-md-6 > .btn').click();
        ...
        //filtrando o pedido corrente
        cy.wait(1500);
        cy.get('#example_filter > label > .form-control').type(segundo_pedido);
